<template>
  <div class="login" @keydown.enter="submitSignIn">
    ...
    <div class="login-right">
      <div class="auth-content">
        <h1 class="login-title">👋 Sign in to {{ title }}</h1>
        <div class="login-content">
          <div class="login-item">
            <div class="login-field">
              <img class="fl" src="@/assets/images/login/people_img.png" />
              <input v-model="form.email" class="login-input w-90" type="text" placeholder="请输入用户名" />
            </div>
          </div>
          <div class="login-item">
            <div class="login-field">
        ...
        <button class="login-btn" :disabled="isDisabled" @click="submitSignIn">
        ...
        <div class="operation-items">
          ...
          <a class="a-link" href="/auth/signUp">立即注册</a>
